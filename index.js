...
var InvalidArgumentError = require('@brucexu/oauth2-server/lib/errors/invalid-argument-error');
var NodeOAuthServer = require('@brucexu/oauth2-server');
var Promise = require('bluebird');
var Request = require('@brucexu/oauth2-server').Request;
var Response = require('@brucexu/oauth2-server').Response;
var UnauthorizedRequestError = require('@brucexu/oauth2-server/lib/errors/unauthorized-request-error');
